...
import { ResourceNotFoundError } from './errors.ts/resource-not-found-error'
import { LateCheckInValidationError } from './errors.ts/late-check-in-validation-error'
...
describe('Validate Check-in Use Case', () => {
    ...
    it('should NOT be able to validate check-in twenty minutes after its creation', async () => {
